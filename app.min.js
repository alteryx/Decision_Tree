...
var numericAndStringTypes = [
  ...
  'String', 'WString', 'V_String', 'V_WString', 'Byte'
];
...
Alteryx.Gui.BeforeLoad = function(manager, AlteryxDataItems){
  ...
  dataItem('curTab', {value: "model"})
  dataItem('curToggle', {value: "toggle-main"})
...
Alteryx.Gui.AfterLoad = function(manager){
  ...
  displayTarget('div-use.weights2', 'use.weights')
  ...
  displayTarget('show-on-rules', 'rules')
  
  displayTarget('show-on-bandscheck', 'bands_check')
...
function handleTabs(curTab){
  ...
  //$("#page-customize .title").text(activePage)
